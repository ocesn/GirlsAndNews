 ...
 */
public class MengFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
        MyRecyclerView.LoadingData,BaseRecyclerViewAdapter.OnItemClickListener<XinWenDao>{

    private String url = "http://d.news.163.com/articlesPage/cute";
    ...
    public void onRefresh() {
        xinwenList.clear();
        url ="http://d.news.163.com/articlesPage/cute";
        new Thread(runnable).start();
    }
