 ...
 */
public class NuanFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
        MyRecyclerView.LoadingData,BaseRecyclerViewAdapter.OnItemClickListener<XinWenDao>{

    private String url = "http://d.news.163.com/articlesPage/warm";
    ...
    public void onRefresh() {
        xinwenList.clear();
        url ="http://d.news.163.com/articlesPage/warm";
        new Thread(runnable).start();
    }
