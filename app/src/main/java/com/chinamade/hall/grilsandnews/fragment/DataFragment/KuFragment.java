 ...
 */
public class KuFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
        MyRecyclerView.LoadingData,BaseRecyclerViewAdapter.OnItemClickListener<XinWenDao>{

    private String url = "http://d.news.163.com/articlesPage/cool";
    ...
    public void onRefresh() {
        xinwenList.clear();
        url ="http://d.news.163.com/articlesPage/cool";
        new Thread(runnable).start();
    }
