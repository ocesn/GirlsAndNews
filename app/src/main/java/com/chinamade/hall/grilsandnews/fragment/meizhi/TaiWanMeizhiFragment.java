 ...
 */
public class TaiWanMeizhiFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener,
    ...
    private String url = "http://www.mzitu.com/taiwan/page/1";
    ...
    public void onRefresh() {
        meiziBeens.clear();
        url = "http://www.mzitu.com/taiwan/page/1";
