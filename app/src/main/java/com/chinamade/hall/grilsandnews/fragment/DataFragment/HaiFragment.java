 ...
 */
public class HaiFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
        MyRecyclerView.LoadingData,BaseRecyclerViewAdapter.OnItemClickListener<XinWenDao>{

    private String url = "http://d.news.163.com/articlesPage/high";
    ...
    public void onRefresh() {
        xinwenList.clear();
        url ="http://d.news.163.com/articlesPage/high";
        new Thread(runnable).start();
    }
